...
const experiences = [
  ...
  // },
  {
    title: "Network Engineer Attachee",
    company: "ICT Authority - Eldoret",
    icon: <FaUsers className="text-4xl text-green-300 mb-2" />,
    color: "border-green-300",
    date: "May 2023 – August 2023",
    description:
      "I worked in ICT Authority the I helped build and maintain ICT Authority networking systems. My main responsibilities include troubleshooting, installing and configuring their networking infrastructure.",
  },
];
