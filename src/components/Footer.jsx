    ...
    <>
      <div className="md:px-10 px-3 mt-15">
        <div className="text-white opacity-50 flex flex-col md:flex-row justify-between items-center my-5">
          <p>@ Copyright {date.getFullYear()} | Daniel Cherogony</p>
          <p className="hidden sm:block text-blue-500">Fullstack Developer</p>
          <p className="hidden sm:block">Networking Engineer</p>
          <p className="hidden sm:block">Designed by <a className="text-primary" href="www.linkedin.com/in/daniel-cherogony-165705382" target="_blank" rel="noreferrer">
            @danielcherogony
          </a></p>
        </div>
        {/* social media */}
      ...
      <div className="flex justify-center ">
        <a className="" href="https://github.com/Danrogo" target="_blank" rel="noreferrer">
          <img src={github} alt="" width={20} />
        </a>
        <a className="mx-2" href="https://www.linkedin.com/in/daniel-cherogony-165705382" target="_blank" rel="noreferrer">
